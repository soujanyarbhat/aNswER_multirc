...
![confidence analysis](https://imgur.com/undefined)
...
- Create a pre-training task with the motive of finding top 4 relevant sentences from a paragraph to answer a given question. Use this in MultiRC to filter the paragraph when predicting the correct option.
- Figure out the problem points in the predictions, especially behind majority labels predicted as TRUE.
